...
</li>`).join("");l.innerHTML=r,m.refresh()}function g(o){const r="https://pixabay.com/api/",s="45156529-f4caada2c6812495035285f69",i=new URLSearchParams({key:s,q:o,image_type:"photo",orientation:"horizontal",safesearch:!0});return fetch(`${r}?${i.toString()}`,{headers:{Accept:"application/json"}}).then(e=>{if(!e.ok)throw new Error(e.status);return e.json()})}const c=document.querySelector(".loader"),u=document.querySelector(".js-form");c.style.display="none";u.addEventListener("submit",L);function L(o){o.preventDefault();const r=o.target.request.value.trim().toLowerCase();r&&(a(c,!0),g(r).then(s=>{if(s.hits.length===0)throw new Error(response.status);a(c,!1),y(s.hits)}).catch(s=>{a(c,!1),w()}).finally(u.reset()))}function w(o){return d.show({message:"Sorry, there are no images matching your search query. Please try again!",color:"red",position:"topRight",closeOnClick:!0})}function a(o,r){r?o.style.display="block":o.style.display="none"}
